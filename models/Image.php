...
class Image extends BaseSubPlacesModel
{
    ...
    {
        $urls = [];
        // Узнаю допустимое количество файлов
    ...
    /**
     * Переносит изображение в папку с местом и создает миниатюры
     * @param $model
     * @param $tempImageUrl
     * @param $toImageUrl
     * @param $type
    ...
    /**
     * Создает миниатюры в зависимости от типа изображения
     */
    ...
    /**
     * Создает миниатюры в зависимости от сценария
     * @return array
     */
